...
def load_model():
    ...
    base_model = layers.Flatten()(base_out)
    base_model = layers.Dense(256)(base_model)
    base_model = layers.Dropout(rate=0.5)(base_model)
    predictions = layers.Dense(NUM_CLASSES)(base_model)
